...
auto ConsoleLog::WriteStdOut(Color color, const WCHAR* format, ...) -> void
{
	if (format == nullptr)
		return;
...
auto ConsoleLog::WriteStdErr(Color color, const WCHAR* format, ...) -> void
{
...
auto ConsoleLog::SetColor(bool stdOut, Color color) -> void
{
	static WORD SColors[]
	{
		0,
