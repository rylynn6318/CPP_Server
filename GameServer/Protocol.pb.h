...
inline uint32_t C_TEST::_internal_id() const {
  return id_;
}
inline uint32_t C_TEST::id() const {
  // @@protoc_insertion_point(field_get:Protocol.C_TEST.id)
  return _internal_id();
}
inline void C_TEST::_internal_set_id(uint32_t value) {
  
  id_ = value;
}
inline void C_TEST::set_id(uint32_t value) {
